...
export const MOCK_ASSETS: Asset[] = [
  ...
  {
    id: "asset-014",
    name: "Sneaker Vault — Grail Editions",
    category: "collectibles",
    description:
      "500+ DS pairs of grail-tier sneakers: Nike x Off-White, Air Jordan 1 OG, Yeezy 350.",
    longDescription:
      "A professionally catalogued vault of 500+ deadstock sneakers representing the most sought-after collaborations and limited releases of the past decade, including Nike x Off-White 'The Ten', Air Jordan 1 OG Chicago, and Adidas Yeezy 350 V1 'Turtle Dove'. Stored in climate-controlled conditions and tracked via StockX authentication certificates.",
    image:
    ...
    minInvestment: 100,
    funded: 91,
    tags: ["Sneakers", "Streetwear", "High Liquidity"],
    highlights: [
      "500+ StockX-authenticated DS pairs",
      "18.2% average annual return (StockX data)",
      "Nike x Off-White 'The Ten' full set included",
      "Liquid exit via StockX / GOAT within 48h",
    ],
  },
  {
    id: "asset-015",
